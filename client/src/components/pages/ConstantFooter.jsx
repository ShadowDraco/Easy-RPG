							...
							<section className='ul'>
								...
								>
									...
									<ul
										...
										style={{ display: 'flex' }}
									>
										<li className='w-100 text-lg'>
											<a href=' https://github.com/ShadowDraco' target='_blank'>
												GitHub
											</a>
										</li>
										<li className='w-100'>
											<a
												href='https://github.com/darranholmes74'
												target='_blank'
											>
												GitHub
											</a>
										...
										<li className='w-100'>
											<a href='https://github.com/KMArtwork' target='_blank'>
												GitHub
											</a>
										</li>
									</ul>
